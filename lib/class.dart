class Film {
  ...
  Film({required this.image, required this.images, required this.title, required this.genre, required this.runtime, required this.desc, required this.rating, required this.link});
}
...
final films = [
  Film(image: 'joker', images: ['joker_im1', 'joker_im2', 'joker_im3',], title: 'Joker', genre: 'Crime, Drama',
      ...
      desc: "A socially inept clown for hire - Arthur Fleck aspires to be a stand up comedian among his small job working dressed as a clown holding "
          ...
          "Dealing with all the negativity and bullying from society, he heads downwards on a spiral, in turn showing how his alter ego, 'Joker,' came to be.", rating: 4.6,
  link: 'https://www.imdb.com/title/tt7286456/plotsummary/#'),
  Film(image: 'adam', images: ['adam_im1', 'adam_im2', 'adam_im3',], title: 'Black Adam', genre: 'Fantastic, Action', runtime: '2h',
      ...
      "Reawakening after 5000 years, Black Adam becomes the world's ruthless protector: an anti-villain to take on the likes of Superman and Wonder Woman.", rating: 4.8,
  link: 'https://www.imdb.com/title/tt6443346/plotsummary/'),
  Film(image: 'avengers', images: ['avengers_im1', 'avengers_im2', 'avengers_im3',], title: 'Avengers', genre: 'Fantastic, Action',  runtime: '2h',
...
"Loki, the adopted brother of Thor, teams-up with the Chitauri Army and uses the Tesseract's power to travel from Asgard to Midgard to plot the invasion of Earth and become a king.", rating: 5,
